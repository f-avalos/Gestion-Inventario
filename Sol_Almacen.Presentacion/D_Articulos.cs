    ...
    public class D_Articulos
    {
        ...
        public string Guardar_ar(int nOpcion, P_Articulos oAr)
        {
            ...
            try
            {
                ...
                {
                    Sqltarea = "insert into tb_articulos values ('"+oAr.Codigo_ar+"', '" + oAr.Descripcion_ar + "', '" + oAr.Marca_ar + "', '" + oAr.Codigo_um + "', '" + oAr.Codigo_ca + "', '" + oAr.Stock_actual + "', '" + oAr.Fecha_crea + "', '" + oAr.Fecha_modifica + "', 1)";
                    /*Sqltarea = "insert into tb_articulos(descripcion_ar, marca_ar, codigo_um, codigo_ca, stock_actual, fecha_crea, fecha_modifica, estado) values('"+ 
                        oAr.Descripcion_ar+"', "+
                        oAr.Marca_ar + "', " +
                        oAr.Codigo_um + "', " +
                        oAr.Codigo_ca + "', " +
